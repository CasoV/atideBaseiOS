...
#define ZEGO_SUPERBOARD_VERSION @"ZegoSuperBoard_v2.5.2.176_240103_192519_ios"
#define ZEGO_SUPERBOARD_MATCH_VERSION @"2.5.2"
...
/// Cursor title position
typedef NS_ENUM(NSUInteger, ZegoSuperBoardCursorTitlePosition) {
    ZegoSuperBoardCursorTitlePositionLeftTop = 0x0 /**<LeftTop  0*/,
    ZegoSuperBoardCursorTitlePositionRightTop = 0x1 /**< RightTop 1*/,
    ZegoSuperBoardCursorTitlePositionRightBottom = 0x2 /**<RightBottom  2*/,
    ZegoSuperBoardCursorTitlePositionLeftBottom = 0x3 /**<LeftBottom  3*/
};
