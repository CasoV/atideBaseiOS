...
+ (BOOL)setGeofencingConfigWithAreaList:(NSArray<NSNumber *> *)areaList
                                   type:(ZIMGeofencingType)type
    // clang-format off
NS_SWIFT_NAME(setGeofencingConfig(with:type:));
// clang-format on
...
- (void)loginWithUserID:(NSString *)userID
               ...
               callback:(ZIMLoggedInCallback)callback
    // clang-format off
NS_SWIFT_NAME(login(with:config:callback:));
// clang-format on
...
- (void)queryConversation:(NSString *)conversationID
         conversationType:(ZIMConversationType)conversationType
                 callback:(ZIMConversationQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryConversation(by:conversationType:callback:));
// clang-format on
...
/// Caution: NextConversation is the riveting point of the query message, which can be null for the first query. In subsequent query, the earliest conversation can be used as nextConversation to query earlier sessions. In paging query, Count in [ZIMConversationQueryConfig] fill each pull the number of sessions.
/// @param config Configuration for session queries.
/// @param callback Callback for conversation pinned list query.
- (void)queryConversationPinnedListWithConfig:(ZIMConversationQueryConfig *)config
                                     callback:(ZIMConversationPinnedListQueriedCallback)callback;
...
- (void)deleteAllConversationsWithConfig:(ZIMConversationDeleteConfig *)config
                                callback:(ZIMConversationsAllDeletedCallback)callback;
...
/// @param callback Callback for updating the pinned state of the conversation.
- (void)updateConversationPinnedState:(BOOL)isPinned
                       conversationID:(NSString *)conversationID
                     conversationType:(ZIMConversationType)conversationType
                             callback:(ZIMConversationPinnedStateUpdatedCallback)callback;
...
- (void)setConversationDraft:(NSString *)draft
              conversationID:(NSString *)conversationID
            conversationType:(ZIMConversationType)conversationType
                    callback:(ZIMConversationDraftSetCallback)callback
    // clang-format off
NS_SWIFT_NAME(setConversationDraft(_:conversationID:conversationType:callback:));
// clang-format on
...
- (void)deleteAllConversationMessagesWithConfig:(ZIMMessageDeleteConfig *)config
                                       callback:(ZIMConversationMessagesAllDeletedCallback)callback
    // clang-format off
NS_SWIFT_NAME(deleteAllConversationMessages(with:callback:));
// clang-format on
...
- (void)updateMessageLocalExtendedData:(NSString *)localExtendedData
                               message:(ZIMMessage *)message
                              callback:(ZIMMessageLocalExtendedDataUpdatedCallback)callback;
...
- (void)searchLocalMessagesByConversationID:(NSString *)conversationID
                           conversationType:(ZIMConversationType)conversationType
                                     config:(ZIMMessageSearchConfig *)config
                                   callback:(ZIMMessagesSearchedCallback)callback
    // clang-format off
NS_SWIFT_NAME(searchLocalMessages(by:conversationType:config:callback:));
// clang-format on
...
- (void)searchGlobalLocalMessagesWithConfig:(ZIMMessageSearchConfig *)config
                                   callback:(ZIMMessagesGlobalSearchedCallback)callback;
...
- (void)searchLocalConversationsWithConfig:(ZIMConversationSearchConfig *)config
                                  callback:(ZIMConversationsSearchedCallback)callback;
...
- (void)addMessageReaction:(NSString *)reactionType
                   message:(ZIMMessage *)message
                  callback:(ZIMMessageReactionAddedCallback)callback;
...
- (void)deleteMessageReaction:(NSString *)reactionType
                      message:(ZIMMessage *)message
                     callback:(ZIMMessageReactionDeletedCallback)callback;
...
- (void)queryMessageReactionUserListByMessage:(ZIMMessage *)message
                                       config:(ZIMMessageReactionUserQueryConfig *)config
                                     callback:(ZIMMessageReactionUserListQueriedCallback)callback;
...
/// @param List of user IDs to query.
/// @param roomID ID of the room to leave.
/// @param callback Callback for querying room user information.
- (void)queryRoomMembersByUserIDs:(NSArray<NSString *> *)userIDs
                           roomID:(NSString *)roomID
                         callback:(ZIMRoomMembersQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryRoomMembers(by:roomID:callback:));
// clang-format on
...
///
/// @param groupAvatarUrl  The group avatar URL that needs to be updated.
/// @param groupID  The group ID of the group avatar URL that will be updated.
/// @param callback  Callback for the result of updating the group avatar URL.
...
- (void)muteGroup:(BOOL)isMute
          groupID:(NSString *)groupID
           config:(ZIMGroupMuteConfig *)config
         callback:(ZIMGroupMutedCallback)callback;

- (void)muteGroupMembers:(BOOL)isMute
                 userIDs:(NSArray<NSString *> *)userIDs
                 groupID:(NSString *)groupID
                  config:(ZIMGroupMemberMuteConfig *)config
                callback:(ZIMGroupMembersMutedCallback)callback;

- (void)queryGroupMemberMutedListByGroupID:(NSString *)groupID
                                    config:(ZIMGroupMemberMutedListQueryConfig *)config
                                  callback:(ZIMGroupMemberMutedListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryGroupMemberMutedList(by:config:callback:));
// clang-format on
...
- (void)searchLocalGroupsWithConfig:(ZIMGroupSearchConfig *)config
                           callback:(ZIMGroupsSearchedCallback)callback;
...
- (void)searchLocalGroupMembersByGroupID:(NSString *)groupID
    ...
    // clang-format off
NS_SWIFT_NAME(searchLocalGroupMembers(by:config:callback:));
// clang-format on
...
///
/// @param invitees  List of invited user ids.
/// @param callID callID of the current call in advanced mode.
/// @param config This section describes how to configure the call invitation.
/// @param callback Invite the callback of the current call.
- (void)callingInviteWithInvitees:(NSArray<NSString *> *)invitees
    ...
    // clang-format off
NS_SWIFT_NAME(callingInvite(with:callID:config:callback:));
// clang-format on

- (void)callJoin:(NSString *)callID
          config:(ZIMCallJoinConfig *)config
        callback:(ZIMCallJoinSentCallback)callback
    // clang-format off
NS_SWIFT_NAME(callJoin(by:config:callback:));
...
- (void)callQuit:(NSString *)callID
    ...
    // clang-format off
NS_SWIFT_NAME(callQuit(by:config:callback:));
// clang-format on
...
- (void)callEnd:(NSString *)callID
    ...
    // clang-format off
NS_SWIFT_NAME(callEnd(by:config:callback:));
// clang-format on
...
- (void)queryCallInvitationListWithConfig:(ZIMCallInvitationQueryConfig *)config
                                 callback:(ZIMCallInvitationListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryCallInvitationList(with:callback:));
// clang-format on

- (void)addUsersToBlacklistWithUserIDs:(NSArray<NSString *> *)userIDs
                              callback:(ZIMBlacklistUsersAddedCallback)callback
    // clang-format off
NS_SWIFT_NAME(addUsersToBlacklist(with:callback:));
// clang-format on

- (void)removeUsersFromBlacklistWithUserIDs:(NSArray<NSString *> *)userIDs
                                   callback:(ZIMBlacklistUsersRemovedCallback)callback
    // clang-format off
NS_SWIFT_NAME(removeUsersFromBlacklist(with:callback:));
// clang-format on

- (void)queryBlacklistWithConfig:(ZIMBlacklistQueryConfig *)config
                        callback:(ZIMBlacklistQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryBlacklist(with:callback:));
// clang-format on

- (void)checkUserIsInBlacklistByUserID:(NSString *)userID
                              callback:(ZIMBlacklistCheckedCallback)callback
    // clang-format off
NS_SWIFT_NAME(checkUserIsInBlacklist(by:callback:));
// clang-format on

- (void)addFriendByUserID:(NSString *)userID
                   config:(ZIMFriendAddConfig *)config
                 callback:(ZIMFriendAddedCallback)callback
    // clang-format off
NS_SWIFT_NAME(addFriend(by:config:callback:));
// clang-format on

- (void)sendFriendApplicationToUserID:(NSString *)userID
                               config:(ZIMFriendApplicationSendConfig *)config
                             callback:(ZIMFriendApplicationSentCallback)callback
    // clang-format off
NS_SWIFT_NAME(sendFriendApplication(to:config:callback:));
// clang-format on

- (void)deleteFriendsByUserIDs:(NSArray<NSString *> *)userIDs
                        config:(ZIMFriendDeleteConfig *)config
                      callback:(ZIMFriendsDeletedCallback)callback
    // clang-format off
NS_SWIFT_NAME(deleteFriends(by:config:callback:));
// clang-format on

- (void)checkFriendsRelationByUserIDs:(NSArray<NSString *> *)userIDs
                               config:(ZIMFriendRelationCheckConfig *)config
                             callback:(ZIMFriendsRelationCheckedCallback)callback
    // clang-format off
NS_SWIFT_NAME(checkFriendsRelation(by:config:callback:));
// clang-format on

- (void)updateFriendAlias:(NSString *)friendAlias
                   userID:(NSString *)userID
                 callback:(ZIMFriendAliasUpdatedCallback)callback
    // clang-format off
NS_SWIFT_NAME(updateFriendAlias(_:userID:callback:));
// clang-format on

- (void)updateFriendAttributes:(NSDictionary<NSString *, NSString *> *)friendAttributes
                        userID:(NSString *)userID
                      callback:(ZIMFriendAttributesUpdatedCallback)callback
    // clang-format off
NS_SWIFT_NAME(updateFriendAttributes(_:userID:callback:));
// clang-format on

- (void)queryFriendsInfoByUserIDs:(NSArray<NSString *> *)userIDs
                         callback:(ZIMFriendsInfoQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryFriendsInfo(by:callback:));
// clang-format on

- (void)searchLocalFriendsWithConfig:(ZIMFriendSearchConfig *)config
                            callback:(ZIMFriendsSearchedCallback)callback
    // clang-format off
NS_SWIFT_NAME(searchLocalFriends(with:callback:));
// clang-format on

- (void)acceptFriendApplicationFromUserID:(NSString *)userID
                                   config:(ZIMFriendApplicationAcceptConfig *)config
                                 callback:(ZIMFriendApplicationAcceptedCallback)callback
    // clang-format off
NS_SWIFT_NAME(acceptFriendApplication(from:config:callback:));
// clang-format on

- (void)rejectFriendApplicationFromUserID:(NSString *)userID
                                   config:(ZIMFriendApplicationRejectConfig *)config
                                 callback:(ZIMFriendApplicationRejectedCallback)callback
    // clang-format off
NS_SWIFT_NAME(rejectFriendApplication(from:config:callback:));
// clang-format on

- (void)queryFriendListWithConfig:(ZIMFriendListQueryConfig *)config
                         callback:(ZIMFriendListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryFriendList(with:callback:));
// clang-format on

- (void)queryFriendApplicationListWithConfig:(ZIMFriendApplicationListQueryConfig *)config
                                    callback:(ZIMFriendApplicationListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryFriendApplicationList(with:callback:));
// clang-format on
@end
