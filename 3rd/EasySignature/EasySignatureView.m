...
-(void) imageRepresentation {
    ...
    CGSize contextSize = CGSizeMake(self.bounds.size.width - 2, self.bounds.size.height - 2);
    ...
    [bgImage drawInRect:CGRectMake(0, 0, contextSize.width, contextSize.height)];
    [self drawRect:CGRectMake(-1, -1, self.bounds.size.width, self.bounds.size.height)];
