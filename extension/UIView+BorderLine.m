...
- (UIView *)borderForColor:(UIColor *)color borderWidth:(CGFloat)borderWidth borderType:(UIBorderSideType)borderType {
    ...
    if (borderType & UIBorderSideTypeBottom) {
        ...
        [self.layer addSublayer:[self addLineOriginPoint:CGPointMake(0.0f, self.frame.size.height-0) toPoint:CGPointMake( self.frame.size.width, self.frame.size.height-0) color:color borderWidth:borderWidth]];
