//
//  ProgressStatisticsDetailCell.m
//  HBConstructionApp
//
...
#import "ProgressStatisticsDetailCell.h"
#import "ProgressStatisticsModel.h"

@interface ProgressStatisticsDetailCell ()
...
@implementation ProgressStatisticsDetailCell
...
- (void)setModel:(ProgressStatisticsModel *)model {
    if (_model != model) {
        ...
        if ([model.status isEqualToString:@"un"]) {
            self.titleLabel4.text = @"未开工";
            self.titleLabel4.textColor = [UIColor whiteColor];
            self.titleLabel4.backgroundColor = [UIColor redColor];
        } else {
            self.titleLabel4.text = @"已开工";
            self.titleLabel4.textColor = UIColorTextNormal;
            self.titleLabel4.backgroundColor = [UIColor whiteColor];
        }
