...
class SupervisorPayModel : NSObject{
    ...
    var no : String?
    var contractAmtStr: String?
    var tcompAmtStr: String?
    var pcompAmtStr: String?
    var compAmtStr: String?
    ...
    init(dictionary: JSON){
        ...
        no = dictionary["no"].stringValue
        contractAmtStr = String(format:"%.f", dictionary["contractAmt"].doubleValue )
        tcompAmtStr =  String(format:"%.f", dictionary["tcompAmt"].doubleValue )
        pcompAmtStr = String(format:"%.f", dictionary["pcompAmt"].doubleValue )
        compAmtStr = String(format:"%.f", dictionary["compAmt"].doubleValue )
