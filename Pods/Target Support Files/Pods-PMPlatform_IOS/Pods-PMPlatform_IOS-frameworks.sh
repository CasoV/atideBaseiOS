...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LMReport/LMReport.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SlideMenuControllerOC/SlideMenuControllerOC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyJSON/SwiftyJSON.framework"
  install_framework "${PODS_ROOT}/TXIMSDK_Smart_iOS/ImSDK_Smart.framework"
